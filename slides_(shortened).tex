...
{\setbeamertemplate{background canvas}{\vbox to \paperheight{\vfil\hbox to \paperwidth{\hfil\includegraphics[width = \paperwidth, height = .825\paperheight, keepaspectratio]{./img/logo.png}\hfil}\vfil}}
\begin{frame}
\titlepage
\end{frame}}
...
%----------------------------------------------------------------------------------------
	...
	\include{./tex/paper_(shortened)}
	
	\include{./tex/performance_(shortened)}

	\include{./tex/replacement_(shortened)}
